...
<div class="row" >
    <div class="col-lg-6">
        <div style="border: #269abc">
            <button class="btn btn-sm" style="margin-left: 10%;margin-bottom: 1%" onclick="RefreshClass()">Refresh this</button>
            <button class="btn btn-sm" style="display: inline;margin-left: 10%;margin-bottom: 1%" onclick="hideClass()">Hide this</button>
