...
//            for (; trainClassStatusID <= 2; trainClassStatusID++) {
...
//                    TrainClassSeatStatus tcss = tcssdo.getTrainClassSeat(trainClassStatusID, p.seat_no, p.coach);
...
//
//                        TrainClassSeatStatus foundtcss = tcssdo.getTrainClassSeat(trainClassStatusID, foundSeat.seat_no, foundSeat.coach);
//
